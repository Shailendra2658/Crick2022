...
public class DeviceListActivity extends AppCompatActivity {
    ...
    private TextView title_paired_devices, title_new_devices;
    ImageView imageViewPair, imageViewBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // requestWindowFeature(Window.FEATURE_INDETERMINATE_PROGRESS);
        ...
        imageViewPair = (ImageView) findViewById(R.id.imageViewPair);
        imageViewPair.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                doDiscovery();
        ...
        Typeface tf = Typeface.createFromAsset(getAssets(),"fonts/FiraSans-Light.ttf");
        title_paired_devices.setTypeface(tf);
        title_new_devices.setTypeface(tf);
        ...
        newDevicesListView.setOnTouchListener(new View.OnTouchListener() {
            // Setting on Touch Listener for handling the touch inside ScrollView
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                // Disallow the touch request for parent scroll on touch of child view
        ...
        setListViewHeightBasedOnChildren(newDevicesListView);
    }
